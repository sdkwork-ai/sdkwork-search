-- SDKWork search consolidated initialization baseline (sqlite)
...
-- baseline source: ddl/baseline/sqlite/0001_search_baseline.sql
...
-- pg_trgm is pre-installed by sdkwork-postgres db:postgres:init on PostgreSQL hosts.
