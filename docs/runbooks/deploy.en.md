# Runbook — sdkwork-search deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-search-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-search/bundle`, loads the image, starts
